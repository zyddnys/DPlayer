        ...
        if (this.showing) {
            ...
            for (let i = 0; i < dan.length; i++) {
                ...
                if (dan[i].border) {
                    ...
                    item.innerHTML = `text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black; border:${dan[i].border}">${dan[i].text}</span>`;
                } else {
                    // item.innerHTML = dan[i].text;
                    item.innerHTML = `text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;">${dan[i].text}</span>`;
                }
