        ...
        if (this.showing) {
            ...
            for (let i = 0; i < dan.length; i++) {
                ...
                if (dan[i].border) {
                    ...
                    item.innerHTML = `<span style="text-shadow: -1.35px 0 black, 0 1.35px black, 1.35px 0 black, 0 -1.35px black; border:${dan[i].border}">${dan[i].text}</span>`;
                } else {
                    // item.innerHTML = dan[i].text;
                    item.innerHTML = `<span style="text-shadow: -1.35px 0 black, 0 1.35px black, 1.35px 0 black, 0 -1.35px black;">${dan[i].text}</span>`;
                }
